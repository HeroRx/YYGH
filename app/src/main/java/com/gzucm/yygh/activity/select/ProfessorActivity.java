            ...
            switch (msg.what){
                case 0:
                    ...
                    for (Department department : list) {
                        ...
                        mainQuery.findObjects(new FindListener<Doctor>() {

                            @Override
                            public void done(final List<Doctor> objects, BmobException e) {
                                Log.i("医生",""+objects);
                                final DDAdapter ddAdapter = new DDAdapter(ProfessorActivity.this, objects);
                                    ...
                                    public void run() {
                                        ...
                                        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                            ...
                                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                                ...
                                                Intent intent = new Intent(ProfessorActivity.this,DoctorDetailActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.search_department:
                Toast.makeText(ProfessorActivity.this,"将为您查询教授",Toast.LENGTH_SHORT).show();
